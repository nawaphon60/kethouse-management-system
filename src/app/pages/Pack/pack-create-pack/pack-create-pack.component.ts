...
@Component({
  selector: 'app-pack-create-pack',
  templateUrl: './pack-create-pack.component.html',
  styleUrls: ['./pack-create-pack.component.css']
})
export class PackCreatePackComponent implements OnInit {
